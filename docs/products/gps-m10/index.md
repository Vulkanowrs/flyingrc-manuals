...
2.0 米 CEP 2D RMS SBAS 辅助（开阔天空处）
...
系统主电源，供电电压为 + 3.3V~+5V, 工作时消耗电流约 25mA
...
GPS，GLONASS，BDS，GALILEO，SBAS 和 QZSS。默认 GPS + GLONASS + SBAS + QZSS 联合定位。对精度要求高的客户，建议用 GPS + GLONASS + SBAS + QZSS + GALILEO 或者 GPS + BDS + SBAS + QZSS + GALILEO 联合定位模式
...
Serial Data - I2C Bus Master/Slave Data
...
Serial Data - I2C Clock Line Master/Slave Data
...
UART Communication Interface, TTL Logic Level
...
Main Power Supply, DC Input

DC 3.6V - 5.5V；5.0V recommended
...
![](../../assets/gps-m10/img14.png)

经典产品、设计独特、好评如潮

中文说明书  Product Manual

![](../../assets/gps-m10/img15.png)
...
![](../../assets/gps-m10/img19.png)

算力强大 飞行稳定精准 接口丰富 操控自如

中文说明书   Product Manual

![](../../assets/gps-m10/img20.png)
...
![](../../assets/gps-m10/img21.png)

电调类

![](../../assets/gps-m10/img22.jpeg)
