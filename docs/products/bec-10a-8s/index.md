# FlyingRC® 10A 2-8S BEC 降压模块产品手册
...
![](../../assets/bec-10a-8s/img01.png)

![](../../assets/bec-10a-8s/img02.jpeg)

![](../../assets/bec-10a-8s/img03.jpeg)

![](../../assets/bec-10a-8s/img04.png)

## 技术参数

产品尺寸：长33.9mm×宽18.5mm×高5.5mm,高10.3mm（贴好散热片）

产品重量：5g（本体）,7.6g（贴好散热片）9g（贴好散热片加上电容）
...
发货内容：BEC*1，16V  680μF电解电容*1，散热片*1

## 产品特点

FlyingRC® 10A 8S BEC V1小体积、高性能的BEC降压模块。
...
输入电压：6-36V，2-8SLiPo（输入电压需高于设定输出电压+0.8V）

输出电压：5V，6V，7V可选。默认输出5V，通过跳线焊盘可选择输出其它两种电压。

输出电流（持续）

无散热（无散热片，无风）:5V8A，6V8A，7V7A

有散热（有散热片或有风）：5V10A，6V10A，7V9A

输出电流（瞬间）：5V12A，6V11A，7V10A

## 使用方法

焊接电源输入线

![](../../assets/bec-10a-8s/img05.png)

输入、输出线默认采用18awg长度10cm硅胶线

![](../../assets/bec-10a-8s/img06.png)

贴散热片用导热胶贴于BEC背面

通过跳线选择电压通过跳线选择电压

![](../../assets/bec-10a-8s/img07.png)
