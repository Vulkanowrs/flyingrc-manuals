# FlyingRC® Mini 40A ESC V1.0 单体电调产品手册 [IMG:media/image3.jpeg]
...
![](../../assets/esc-mini-40a/img01.png)

![](../../assets/esc-mini-40a/img02.png)

![](../../assets/esc-mini-40a/img03.png)

## 技术参数

![](../../assets/esc-mini-40a/img04.png)

主控QF32F4AK8U7，集成栅极驱动器ID6288，场效应管HYG022N04LS1C1；
...
尺寸及重量：22.7mm*13.8mm*3.8mm，2.2g；
...
新版本AM32固件默认仅支持DSHOT300 & 600，支持其它协议需要在AM32 ESC TOOLS中修改
...
极致的 Mini 体积，适合小型及微型 FPV 载机。使用集成栅极驱动器的 MCU 减小非功率器件占用的 PCB 面积，增强了 PCB 的过流能力

场效应管 / MOS

采用 6 颗 HYG022N04LS1C1 N-MOSFET，导通内阻仅 2.0mΩ，耐压 40V（对于支持 6S 非常重要）。对比同类型 mini 电调采用的 MOS，导通内阻明显降低，发热减小显著

支持宽电压输入

采用双级 LDO 降压的方案为栅极驱动器及 MCU 供电，支持 2 - 6S 宽电压。对比同类型 Mini 电调仅采用单 LDO 降压，发热更为集中，支持的电压仅最高 4S

## 产品特点

极致的Mini体积，适合小型及微型FPV载机。使用集成栅极驱动器的MCU减小非功率器件占用的PCB面积，增强了PCB的过流能力。

AM32固件，开启正弦波启动与StallProtection后，低速扭矩大，适合蚊车使用。

采用6颗 HYG022N04LS1C1 N-MOSFET，导通内阻仅2.0mΩ，耐压40V（对于支持6S非常重要），对比同类型mini电调采用的MOS导通内阻明显降低，发热减小显著。

采用双级LDO降压的方案为栅极驱动器及MCU供电，支持2~6S宽电压。对比同类型Mini电调仅采用单LDO降压，发热更为集中，支持的电压仅最高4S。
...
![](../../assets/esc-mini-40a/img05.jpeg)

正面3D渲染示意图

![](../../assets/esc-mini-40a/img06.png)

反面3D渲染示意图

**2.使用前准备：**

![](../../assets/esc-mini-40a/img07.png)

### 电调接线示意图

![](../../assets/esc-mini-40a/img08.png)
...
![](../../assets/esc-mini-40a/img09.jpeg)

![](../../assets/esc-mini-40a/img10.png)
...
![](../../assets/esc-mini-40a/img15.jpeg)
...
![](../../assets/esc-mini-40a/img18.png)

经典产品、设计独特、好评如潮

中文说明书  Product Manual

![](../../assets/esc-mini-40a/img19.png)
