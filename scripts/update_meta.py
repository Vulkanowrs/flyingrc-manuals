...
ROWS = [
    ...
    ("h7wlite-mk2", "FlyingRC® H7Wlite MK2", "flight-controller", "h7wlite", "active"),
    ("esc-4in1-45a", "FlyingRC® 4IN1 45A ESC", "esc", "45a", "active"),
    ("esc-4in1-75a", "FlyingRC® 4IN1 75A ESC", "esc", "4in175", "active"),
    ("esc-mini-40a", "FlyingRC® AM32 Mini 40A", "esc", "mini40", "active"),
